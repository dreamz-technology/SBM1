...
public class SendScheduleMeetingAdapter extends RecyclerView.Adapter<SendScheduleMeetingAdapter.basicClass> {
    ...
    public SendScheduleMeetingAdapter(Context context, OnClickRefresh onClickRefresh) {
...
//    }
    ...
    @Override
    public SendScheduleMeetingAdapter.basicClass onCreateViewHolder(ViewGroup parent, int viewType) {
        View inflate = LayoutInflater.from(context).inflate(R.layout.send_schedule_metting_layout, null);
    ...
    @Override
    public void onBindViewHolder(SendScheduleMeetingAdapter.basicClass holder, @SuppressLint("RecyclerView") int position) {
...
//        });
        ...
        client.post(CancelMeeting + sInterList.get(posititon).getMeetingId(),
                new TextHttpResponseHandler() {
                    ...
                    public void onSuccess(int statusCode, Header[] headers, String responseString) {
                        ...
                        try {
                            array = new JSONObject(responseString);
                            Log.d("TAG", " Response is:-" + responseString);
                            onClickRefresh.onRefresh();
                            for (int i = 0; i < array.length(); i++) {
                                //JSONObject product = array.get(i);
    ...
    public class basicClass extends RecyclerView.ViewHolder {
        TextView fname, age, qualification, candidid, viewProfile, number;
...
//            send = itemView.findViewById(R.id.Ilayout_invitations);
            ...
            //btn_accept_meeting = itemView.findViewById(R.id.btn_accept_meeting);
