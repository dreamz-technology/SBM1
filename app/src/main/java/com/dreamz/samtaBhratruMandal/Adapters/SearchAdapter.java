...
public class SearchAdapter extends RecyclerView.Adapter<SearchAdapter.basicClass> {

    List<SearchResultsItem> muserList = new ArrayList<>();
    ...
    public SearchAdapter(Context context, List<SearchResultsItem> sliderItem,GetUserList getUserList) {
        this.context = context;
        this.muserList = sliderItem;
        this.getUserList=getUserList;
    }

 /*   public void addItem(List<SearchResultDTO> sliderItem) {
    ...
    @Override
    public SearchAdapter.basicClass onCreateViewHolder(ViewGroup parent, int viewType) {
        View inflate = LayoutInflater.from(parent.getContext()).inflate(R.layout.search_layout, null);
    ...
    @Override
    public void onBindViewHolder(SearchAdapter.basicClass holder, @SuppressLint("RecyclerView") int position) {

        if (muserList.get(position).getProfileImage() != null && !muserList.get(position).getProfileImage().equals("")) {

            Glide.with(context)
                    .load(serverConstants.imageBaseUrl + muserList.get(position).getProfileImage())//"https://staging.samatabhratrumandal.com/"+
                    .centerCrop()
        ...
        holder.age.setText("Age: " + muserList.get(position).getAge() + " yrs");
...
//                        showLoader.dismissDialog();
        ...
        holder.kundli.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View v) {
    ...
    public class basicClass extends RecyclerView.ViewHolder {
        TextView fname, age, qualification, viewProfile, kundli, tvBookmark,tvIsInvite;
        LinearLayout send, bookmarks;
        ImageView userProf, ivHeart;

        public basicClass(View itemView) {
            super(itemView);
            userProf = itemView.findViewById(R.id.image_search_layout);
            fname = itemView.findViewById(R.id.txt_search_layout_name);
            age = itemView.findViewById(R.id.txt_search_layout_age);
            qualification = itemView.findViewById(R.id.txt_search_layout_education);
            viewProfile = itemView.findViewById(R.id.txt_view_profile);
            bookmarks = itemView.findViewById(R.id.layout_bookmarks);
            send = itemView.findViewById(R.id.layout_invitations);
            kundli = itemView.findViewById(R.id.tv_viewKundali);
